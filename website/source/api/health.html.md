...
- `ns` `(string: "")` - <span class="label-enterprise">Enterprise</span> Specifies the namespace to list checks.
...
- `ns` `(string: "")` - <span class="label-enterprise">Enterprise</span> Specifies the namespace of the service.
  This value may be provided by either the `ns` URL query parameter or in the
  `X-Consul-Namespace` header. If not provided at all, the namespace will be inherited
