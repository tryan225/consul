...
* **Namespace** <span class="label-enterprise">Enterprise</span> - The namespace this policy resides within. (Added in Consul Enterprise 1.7.0)
...
* **Namespace Management** <span class="label-enterprise">Enterprise</span> - Every namespace created will have a policy injected with the name `namespace-management`. This policy gets injected with a randomized UUID and may be managed like any other user-defined policy
